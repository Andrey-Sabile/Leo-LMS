...
export class ClassroomsClient implements IClassroomsClient {
    ...
    removeStudentFromClassroom(id: number, studentId: number): Observable<void> {
        let url_ = this.baseUrl + "/api/Classrooms/{id}/students/{studentId}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processRemoveStudentFromClassroom(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processRemoveStudentFromClassroom(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processRemoveStudentFromClassroom(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    removeTeacherFromClassroom(id: number, teacherId: number): Observable<void> {
        let url_ = this.baseUrl + "/api/Classrooms/{id}/teachers/{teacherId}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processRemoveTeacherFromClassroom(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processRemoveTeacherFromClassroom(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processRemoveTeacherFromClassroom(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface ITeachersClient {
    ...
    getTeacherLookup(search: string | null | undefined, pageNumber: number, pageSize: number): Observable<PaginatedListOfTeacherLookupDto>;
...
export class TeachersClient implements ITeachersClient {
    ...
    getTeacherLookup(search: string | null | undefined, pageNumber: number, pageSize: number): Observable<PaginatedListOfTeacherLookupDto> {
        let url_ = this.baseUrl + "/api/Teachers/lookup?";
        if (search !== undefined && search !== null)
            url_ += "Search=" + encodeURIComponent("" + search) + "&";
        if (pageNumber === undefined || pageNumber === null)
            throw new Error("The parameter 'pageNumber' must be defined and cannot be null.");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTeacherLookup(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTeacherLookup(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PaginatedListOfTeacherLookupDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PaginatedListOfTeacherLookupDto>;
        }));
    }

    protected processGetTeacherLookup(response: HttpResponseBase): Observable<PaginatedListOfTeacherLookupDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PaginatedListOfTeacherLookupDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class AddTeacherToClassroomCommand implements IAddTeacherToClassroomCommand {
    ...
    static fromJS(data: any): AddTeacherToClassroomCommand {
        data = typeof data === 'object' ? data : {};
        let result = new AddTeacherToClassroomCommand();
        result.init(data);
        return result;
    }
...
export class PaginatedListOfTeacherLookupDto implements IPaginatedListOfTeacherLookupDto {
    items?: TeacherLookupDto[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
    hasPreviousPage?: boolean;
    ...
    constructor(data?: IPaginatedListOfTeacherLookupDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(TeacherLookupDto.fromJS(item));
            }
            this.pageNumber = _data["pageNumber"];
            this.totalPages = _data["totalPages"];
            this.totalCount = _data["totalCount"];
    ...
    static fromJS(data: any): PaginatedListOfTeacherLookupDto {
        data = typeof data === 'object' ? data : {};
        let result = new PaginatedListOfTeacherLookupDto();
        result.init(data);
        return result;
    }
...
export interface IPaginatedListOfTeacherLookupDto {
    items?: TeacherLookupDto[];
    pageNumber?: number;
    totalPages?: number;
    totalCount?: number;
...
export class TeacherLookupDto implements ITeacherLookupDto {
    id?: number;
    firstName?: string;
    lastName?: string;
    email?: string;

    constructor(data?: ITeacherLookupDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TeacherLookupDto {
        data = typeof data === 'object' ? data : {};
        let result = new TeacherLookupDto();
        result.init(data);
        return result;
    }
...
export interface ITeacherLookupDto {
    id?: number;
    firstName?: string;
    lastName?: string;
    email?: string;
